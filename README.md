...
The robot follows connected blocks in order. Use movement blocks to move forward or turn, and logic blocks to build simple algorithms. If no blocks are connected to START, the game will ask you to add instructions.
